...
class EmployeesListWindow(QWidget):
    ...
    def ui_employees_list_window(self):
        ...
        for i, employee in enumerate(self.employees):
            item_full_name = QTableWidgetItem(f"{employee.last_name} {employee.first_name} {employee.middle_name}")
        ...
        self.employees_table.cellDoubleClicked.connect(lambda: open_employee_info_window(self, self.employees[self.employees_table.currentRow()]))
